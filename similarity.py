...
class Similarity():
    ...
    def find_similar_channels_for_channel(self, channel_name):
        ...
        channel_as_query = \
            self.analysed.model[self.analysed.corpus[channel_text_id]]

        sims = sorted(enumerate(self.index[channel_as_query]),
...
if __name__ == '__main__':
    ...
    parser.add_option("-c", "--channel", dest="channel",
                      help="name of channel we want to find similarities to")
    parser.add_option("-t", "--topn", dest="topn",
                      help="limit to Top N scores")
